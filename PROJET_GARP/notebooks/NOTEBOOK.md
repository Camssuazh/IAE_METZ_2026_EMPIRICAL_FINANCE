...
* **Style :** Les résultats montrent que le portefeuille GARP surperforme nettement les deux styles avec un rendement annualisé de 16,6 % (contre 10,2 % pour le Growth et 5,3 % pour le Value) et un ratio de Sharpe supérieur malgré une volatilité plus élevée. Son tracking error plus faible face au Growth, son information ratio particulièrement élevé contre le Growth, son bêta Growth supérieur à 1 (Beta ~1.12) (et exposition Value très faible), ainsi que sa corrélation élevée avec le Growth confirment une dominante clairement orientée vers la croissance.
